...
def create_default_config() -> Dict:
    """
    Creates a default config file in the PathologyUI directory.
    ...
    default_config = {
        ...
        'max_backups': 10,
        'backup_dir': os.path.expanduser('~/PathologyUI/backups'),
        'log_dir': os.path.expanduser('~/PathologyUI/logs'),
...
def setup_logging(log_out_path: str, resource_directory: str = resource_dir) -> Tuple[logging.Logger, logging.Logger]:
    ...
    """
    full_log_file_path = os.path.expanduser(os.path.join(log_out_path, "PathologyUI.log"))
